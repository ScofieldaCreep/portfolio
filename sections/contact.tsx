...
export default function ContactSection() {
  ...
  const sendEmail = (e: FormEvent<HTMLFormElement>): void => {
    e.preventDefault();
    emailjs.sendForm('service_p7t627n', 'template_i5mpd1p', formRef.current, 'DpsnuoeGekiqBbBI6').then(
      (res) => {
      ...
      <Card>
        <div className="grid gap-8 grid-cols-1 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-8">
            <ContactCard
              title="Call Me If You Have A ... Vacant Position !"
              icon={<FaPhoneVolume className="fill-[#333] text-lg" />}
              text="929 - 705 - 4920"
              btnText="Call Chi"
            />
            <ContactCard
              title="Thanks for Reaching Out, or Asking Me Out !"
